<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teste.aspx.cs" Inherits="Roteirizacao.Teste" %>
...
<%--    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<script src="javascripts/cnv.js"></script>
...
<body>
    <form id="form1" runat="server">
		...
		<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tab_origin">
				<thead>
					<tr><td class="text-left" colspan="4"><b>Origem</b></td></tr>
				</thead>
								
				<tr > <td> <input type="text" id='origin' name='origin' class=" form-control input-md dest" placeholder='Origem' />
						</td></tr>
		</table>
			<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tab_logic">
				<thead>
					<tr >
				...
				<!--<tbody>-->
						...
						<tr id='addr1'>
							...
							<td>
								...
								<td>
								<input type="number" step="1"  min="1" max="5" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  title="Numbers only" name='qty1' id='qty1' onChange="removeChar(qty1)"; class=" form-control input-md" placeholder='Demanda (kg)' />
								</td>
			...
			<a id="add_pickup_destination"  class="btn  pull-left"  >Adicionar Entrega</a>&nbsp &nbsp
			<a id="add_prod"  class="btn  pull-center" >Adicionar produto</a>
			<a id="delete_prod" class="btn  pull-right" >Remover produto/Entrega</a>
			...
			<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tab_trucks">
				<thead>
				<tr><td class="text-left" colspan="4"><b>Veículos</b></td></tr>
					<tr >
						<th class="text-center" style="display:none;">
							#
						</th>
				...
				<tbody>
					...
					<a id="add_truck" class="btn  pull-left">Adicionar Veículo</a>&nbsp
					...
					<a id='delete_truck' class="btn pull-center ">Remover Veículo</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					...
					<a id='send' class="btn btn-primary pull-center ">ROTEIRIZAR</a>&nbsp

					<a id='send' class="btn btn-danger pull-center" onClick="window.location.reload();">RECOMEÇAR</a>	
			   ...
			   $("#delete_truck").click(function(){
				  ...
				  getFormData(function(res) {
								if (res) {
									...
									$.post('http://209.124.64.153:4120/calc', {data:data}, function(result) {
